...
class SwitchlikeCheckbox extends StatelessWidget {
  SwitchlikeCheckbox(
      {@required this.checked, this.textOff = "OFF", this.textOn = "ON"});
  ...
  Widget build(BuildContext context) {
    var tween = MultiTrackTween([
      ...
      Track("text")
          .add(Duration(milliseconds: 500), ConstantTween(textOff))
          .add(Duration(milliseconds: 500), ConstantTween(textOn)),
      Track("rotation")
